...
bluetooth.registration = function (cb) {
  ...
  bluetooth.stopAdvertising(function () { //Stop any advertising
    ...
    if (bluetooth.state === 'poweredOn' && !bluetooth.advertising) {
      ...
      bluetooth.startAdvertising("Matrix", [Matrix.config.registrationUUID], function (err) {
        if (err) { 
          bluetooth.advertising = false;
...
bluetooth.configuration = function (cb) {
  ...
  bluetooth.stopAdvertising(function () { 
    ...
    var characteristicList = [configurationNotifyCharacteristic, checkIdAndSecretCharacteristic, checkAuthCharacteristic, readConfigCharacteristic, writeConfigCharacteristic, scanNetworksCharacteristic];
    ...
    if (bluetooth.state === 'poweredOn' && !bluetooth.advertising) {
      ...
      bluetooth.startAdvertising("Matrix", [Matrix.config.configurationUUID], function (err) {
        if (err) { 
          bluetooth.advertising = false;
