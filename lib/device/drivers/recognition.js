...
var matrixVision, matrixMalos, matrixRPC,
  RecognitionService,
  protoVisionBuilder,
  protoMalosBuilder;
...
module.exports = {
  ...
  init: function(){
    protoVisionBuilder = Matrix.service.protobuf.vision.recognition;
  ...
  prepare: function(options, cb){
    ...
    if ( options.train && options.recognize === true ){
