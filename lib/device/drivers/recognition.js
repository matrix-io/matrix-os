...
module.exports = {
  ...
  prepare: function (component, cb) {
    ...
    driverConfig.malos_eye_config = new DeviceDriver.MalosEyeConfig;
  ...
  config: function (options) {
    ...
    // setup malos_eye_
    var eyeConfig = new DeviceDriver.DriverConfig;
    eyeConfig.malos_eye_config = new DeviceDriver.MalosEyeConfig;
