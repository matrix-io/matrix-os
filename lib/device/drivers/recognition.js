...
function startRecognitionService() {
  ...
  if (_.isUndefined(RecognitionService)) {
    RecognitionService = new RecognitionRPC.RecognitionService(
...
module.exports = {
  ...
  init: function () {
    ...
    RecognitionRPC = Matrix.service.grpc.vision.recognition_service;
  ...
  prepare: function (component, cb) {
    ...
    var config = new DeviceDriver.config;
    config.set_delay_between_updates(0.05);
    config.set_timeout_after_last_ping(15);
    config.malos_eye_config = new DeviceDriver.MalosEyeConfig;
    var cameraConfig = new DeviceDriver.CameraConfig;
    cameraConfig.set_camera_id(0);
    cameraConfig.set_width(800);
    cameraConfig.set_height(600);

    config.malos_eye_config.set_camera_config(cameraConfig);
  ...
  config: function (options) {
    ...
    config.malos_eye_config.object_to_detect.push(
