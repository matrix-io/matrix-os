var protoBuilder, VisionDriver, DeviceDriver;
...
module.exports = {
  ...
  prepare: function (options, cb) {
    ...
    var camConfig = new DeviceDriver.CameraConfig;
  ...
  config: function (options) {
    ...
    // send config
    config.malos_eye_config.object_to_detect.push(DeviceDriver.EnumMalosEyeDetectionType[options.enumName]);
