...
module.exports = {
  ...
  init: function(){
    ...
    ZB = function(){
      ...
      // LEVEL 1
      self.init = function( timeout = 15, delay = 1 ){
      ...
      const __zcl = function(){
        if ( _.isUndefined( cmds.zcl.node_id ) || _.isUndefined( cmds.zcl.endpoint_id ) ){
