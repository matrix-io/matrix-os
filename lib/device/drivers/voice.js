...
module.exports = {
  ...
  prepare: (options, cb) => {
    ...
    let config = new IODriver.WakeWordParams;
    config.wakeWord = vc.wakeword;
    config.lmPath = "/home/pi/assets/9854.lm";
    config.dicPath = "/home/pi/assets/9854.dic";
    ...
    cb(IODriver.WakeWordParams.encode(config).finish());
  },
  stop: () => {
