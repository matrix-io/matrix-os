...
module.exports = {
  ...
  start: function(options){
    ...
    // Use device libs for the sensor data
    Matrix.device[options.name].start(options.options, function(){
      Matrix.device[options.name].read(function (data) {

        debug('device.sensor.read>', data);
