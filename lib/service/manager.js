        ...
        if (!err) {
          ...
          if (process.env.hasOwnProperty('DOCKER_APPS')) {
            ...
            try {
              ...
              // monitor app process
              app.process.on('exit', function() {
                console.log('App Closed', name, app.process.exitCode);
              })

              app.process.on('disconnect', function() {
                console.log('App IPC Channel Closed', name);
              })

              app.process.on('warning', function(w) {
                console.log('App Warning:', name, w);
              })
              app.process.on('uncaughtException', function(e) {
                console.log('Exception:', name, e);
              })
