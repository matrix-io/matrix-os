...
function stopApp(id, cb) {
  ...
  if (id === 'all-applications'){
    ...
    if (!_.isUndefined(applicationInstance)) { //If the application was already started
      applicationInstance.setRuntimeStatus('inactive');

      // heads will roll o/ |o| \8/
      (function executioner() {require('child_process').exec( 'kill ' + applicationInstance.pid )})();
...
>>>>>>> 26320175236c4cbc1ec6453f7087f2bcaaa69271
