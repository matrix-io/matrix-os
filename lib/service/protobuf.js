...
// enable service mode to point to system proto store
const protosPath =  ( process.env.hasOwnProperty('MATRIX_MODE') && process.env.MATRIX_MODE === 'service') ? '/usr/share/matrix-protos/' : __dirname + '/../../proto';
