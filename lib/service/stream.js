var io = require('engine.io-client')('ws://', + Matrix.streamingServer.slice(Matrix.streamingServer.indexOf('://') + 2));
var socket;
...
function initSocket() {
  ...
  if ( !_.isUndefined(socket) && socket.connected === true){
    ...
    socket.on('connect', function() {
      // TODO: Send configuration of open apps on socket connect / reconnect vs on app start. This will solve for reconnection issues.
