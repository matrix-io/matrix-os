...
function initSocket(cb) {
  ...
  if (!socket.hasListeners('open')) { 
    ...
    console.log('Socket open listener already in place');
  }

  if (!socket.hasListeners('close')) {
