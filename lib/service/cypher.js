...
module.exports = {
  init: function () {
    if (_.has(Matrix, 'deviceSecret')) key = _.pad(Matrix.deviceSecret.substring(0, keyLength), keyLength, 'f00e1337');
  ...
  encrypt: function(text, prefix) {
    ...
    if (_.isUndefined(key) || !_.has(Matrix, 'deviceSecret')) {
      //TODO Too much?
      module.exports.init();
      if (_.isUndefined(key) || !_.has(Matrix, 'deviceSecret')) throw 'Cypher missing device details, unable to continues';
    }
