...
module.exports = {
  init: function() {
    var nonce = (Matrix.hasOwnProperty('deviceSecret') && !_.isUndefined(Matrix.deviceSecret)) ? Matrix.deviceSecret : '';
    // standardlize length
    key = _.pad(nonce.substring(0, keyLength), keyLength, 'f00e1337')
  },
